...
storiesOf('Seed Catalog', module)
  .add('Carousel JS', () => html`
    ...
    <p class="package">
      <span class="gree">// Optional attributes</span>
      ...
      <span class="yellou">render</span>() {
        <span class="purp">return</span> <span class="yellou">html</span>\`
          <span class="gre"><</span><span class="blu">seed-carousel </span><span class="light-txt">arrows stepper square</span><span class="gre">></span>
            <span class="gre"><</span><span class="blu">img </span><span class="light-txt">src</span>=<span class="ora">"assets/photo1.jpg"</span> <span class="light-txt">alt</span>=<span class="ora">"Photo 1"</span><span class="gre">></span>
            <span class="gre"><</span><span class="blu">img </span><span class="light-txt">src</span>=<span class="ora">"assets/photo2.jpg"</span> <span class="light-txt">alt</span>=<span class="ora">"Photo 2"</span><span class="gre">></span>
            <span class="gre"><</span><span class="blu">img </span><span class="light-txt">src</span>=<span class="ora">"assets/photo3.jpg"</span> <span class="light-txt">alt</span>=<span class="ora">"Photo 3"</span><span class="gre">></span>
            <span class="gre"><</span><span class="blu">img </span><span class="light-txt">src</span>=<span class="ora">"assets/photo4.jpg"</span> <span class="light-txt">alt</span>=<span class="ora">"Photo 4"</span><span class="gre">></span>
          <span class="gre">${`</`}</span><span class="blu">seed-carousel</span><span class="gre">></span>
        \`;
      }
    }
