  ...
  .add('Stepper', () => html`
    ...
    <div class="container">
      ...
      <div class="stepper">
        ...
        <p class="package">
    <span class="gre"><</span><span class="blu">seed-spinner</span> <span class="light-txt">.index</span>=<span class="ora">"</span><span class="blu">\$\{</span><span class="gree">0</span><span class="blu">}</span><span class="ora">"</span> <span class="light-txt">.size</span>=<span class="ora">"</span><span class="blu">\$\{</span><span class="gree">4</span><span class="blu">}</span><span class="ora">"</span><span class="gre">></span><span class="gre">${'</'}</span><span class="blu">seed-spinner</span><span class="gre">></span>

    <span class="gre"><</span><span class="blu">seed-spinner</span> <span class="light-txt">.index</span>=<span class="ora">"</span><span class="blu">\$\{</span><span class="gree">2</span><span class="blu">}</span><span class="ora">"</span> <span class="light-txt">.size</span>=<span class="ora">"</span><span class="blu">\$\{</span><span class="gree">12</span><span class="blu">}</span><span class="ora">"</span> <span class="light-txt">.square</span>=<span class="ora">"\$\{true}"</span><span class="gre">></span><span class="gre">${'</'}</span><span class="blu">seed-spinner</span><span class="gre">></span>
