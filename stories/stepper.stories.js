...
storiesOf('Seed Catalog', module)
  .add('Stepper', () => html`
    ...
    <span class="gre"><</span><span class="blu">seed-stepper</span> <span class="light-txt">.index</span>=<span class="ora">"\$\{0}"</span> <span class="light-txt">.size</span>=<span class="ora">"\$\{3}"</span> <span class="light-txt">colorActive</span>=<span class="ora">"#2dabb4"</span> <span class="light-txt">colorBack</span>=<span class="ora">"#2dabb445"</span> <span class="gre">${'</'}</span><span class="blu">seed-stepper</span><span class="gre">></span>
    </p>
    `);
