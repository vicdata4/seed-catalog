...
storiesOf('Seed', module)
  .add('Intro', () => html`
    ...
    <p class="paragraph">Seed Catalog is a free and open-source <a href="https://github.com/vicdata4/seed-catalog" target="_blank" class="sd-btn-mix sm black">web-components</a> library. It contains CSS-styles and standard-web based templates such as buttons, modals, dropdowns and other interface components.</p>
    ...
    <br><br>
    <button class="sd-btn-mix sm black"><i class="material-icons red">list</i>List of components</button><br><br>
